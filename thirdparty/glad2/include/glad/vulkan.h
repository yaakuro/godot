/**
 * Loader generated by glad 2.0.0-beta on Sun Jul 29 20:53:47 2018
 *
 * Generator: C/C++
 * Specification: vk
 * Extensions: 4
 ...
 *
 * Commandline:
 *    --api='vulkan=1.1' --extensions='VK_KHR_swapchain,VK_KHR_surface,VK_EXT_debug_report,VK_KHR_win32_surface' c --loader --header-only
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.1&extensions=VK_KHR_swapchain%2CVK_KHR_surface%2CVK_EXT_debug_report%2CVK_KHR_win32_surface&generator=c&options=LOADER%2CHEADER_ONLY
 *
 */
...
#if defined(VK_USE_PLATFORM_WIN32_KHR)
PFN_vkGetPhysicalDeviceWin32PresentationSupportKHR glad_vkGetPhysicalDeviceWin32PresentationSupportKHR;
...
#if defined(VK_USE_PLATFORM_WIN32_KHR)
PFN_vkCreateWin32SurfaceKHR glad_vkCreateWin32SurfaceKHR;
