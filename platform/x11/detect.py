...
#    env.Append(CPPFLAGS=['-DX11_ENABLED', '-DUNIX_ENABLED', '-DVULKAN_ENABLED', '-DOPENGL_ENABLED', '-DGLES_ENABLED', '-DGLES_OVER_GL'])
    env.Append(CPPFLAGS=['-DX11_ENABLED', '-DUNIX_ENABLED', '-DVULKAN_ENABLED', '-DVKF_SURFACE_XLIB',])
